...
export default function TypingPromptInput() {
  const prompts = [
    "Analyze my jab technique and power delivery in this sparring session...",
    "Break down my defensive movements and counter-attack timing...",
    "Evaluate my footwork and ring positioning during this fight...",
    "Score my performance against my sparring partner and identify improvements...",
    "Assess my combination punching accuracy and flow...",
  ]
